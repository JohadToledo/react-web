...
export function Home(){
      const downloadFileAtURL = () => {
        ...
        return(
            ...
            id="home" 
            className="w-screen md:max-w-7xl h-screen sm:h-[calc(100vh-20px)] overflow-hidden flex flex-row-reverse z-1">
            ...
            <div className="md:px-5 h-2/3 md:h-screen w-screen flex flex-col md:flex-row justify-center items-center">
                ...
                <span className="py-2">I&#39;m <span className="font-bold relative inline-block after:content-[''] after:absolute after:bottom-0 after:rounded after:left-0 after:w-full after:h-1.5 after:bg-teal-900">Johad</span></span>
                <Typewriter />
                <Social />
                <Link >
