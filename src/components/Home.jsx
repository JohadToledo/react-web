      ...
      const downloadFileAtURL = () => {
        ...
        return(
            ...
            <div className="md:px-5 h-2/3 md:h-screen w-screen flex flex-col md:flex-row justify-center items-center bg-transparent">
                ...
                <span className="bg-transparent">Hi,</span>
                <span className="bg-transparent py-2">I&#39;m <span className="font-bold text-teal-600 relative inline-block after:content-[''] after:absolute after:bottom-0 after:rounded after:left-0 after:w-full after:h-1.5 after:bg-teal-900 bg-transparent">Johad</span></span>
                <Typewriter />
                <Social />
                <Link >
                    ...
                    value="download" 
                    className='border-3 font-bold rounded w-40 bg-teal-500 py-5 sm:py-2 text-white text-lg flex justify-center items-center  hover:bg-teal-600'>
