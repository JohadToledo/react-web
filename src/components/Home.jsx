    ...
    return(
        <section id="home" className="w-screen max-w-7xl h-[calc(100vh-20px)] overflow-hidden flex flex-row-reverse items-end"> 
            <div className="h-screen w-screen p-8 leading-10 font-bold flex flex-col justify-center">
                ...
                <Link to='https://www.linkedin.com/in/johad-toledo-webdeveloper/'><button id="downloadCV" onClick={downloadFileAtURL} value="download" className="bg-white text-3xl flex items-center rounded-3xl my-4 px-8"><img className='p-0 w-8 bg-transparent'src={downloadImg} alt="download" /><span className="bg-transparent pl-2">Resume</span></button></Link>
            </div>
