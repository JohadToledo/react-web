...
export function Home(){
    ...
    return(
        <section id="home" className="w-screen md:max-w-7xl h-screen sm:h-[calc(100vh-20px)] overflow-hidden flex flex-row-reverse"> 
            <div className="md:px-5 h-2/3 sm:h-screen w-screen flex flex-col md:flex-row justify-center items-center content-center ">
                <div className="lg:pl-12 h-full sm:pl-0 md:pl-0 text-xl w-2/3 leading-7 font-thin flex flex-col justify-center items-center">
                ...
                <p className="text-center">A Web developer building reactive web apps.</p>
                <Social />
                <Link >
